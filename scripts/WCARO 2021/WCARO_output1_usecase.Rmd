...
ggplot(data = pie_data_1, aes(x = "", y = value, fill=variable )) + 
  ...
  labs(title="Figure 1: Projected coverage of water points") +
...
ggplot() +
  ...
  labs(title="Figure 2: Water point density vs population density in Kambia", color="")
...
ggplot() +
  ...
  scale_fill_manual(values=c("#1EAFED", "#FFCD60")) +
  labs(
    title="Figure 3: Comparison of Population density and water point density by type of water points",
    x="", y="") +
  theme(legend.position = "right",
        legend.title = element_blank(),
        legend.text = element_text(size=8),
...
Figure 4  shows the location of the different water points in Kambia with the functionality status. The highest concentration of water points are seen to be in the middle  and more to the southern part of the district and the lowest concentration is in the outer parts. Along the eastern border there seem to be quite some non functional water points.
...
ggplot() +
  ...
  labs(
    title="Figure 5 : Comparison of population and water point density by functionality of improved water points",
    x="", y="") +
  theme(legend.position = "right",
        legend.title = element_blank(),
        legend.text = element_text(size=8),
...
wp_coverage_fb_density %>%
  select(ADM2, Total_pop_fb, "Percentage served within 500m radius",
         ...
         "Actual percentage of the population served" ) %>% melt() %>%
  kbl("html", caption="Table 6:") %>%
  kable_styling("striped", position = "center", font_size = 11, full_width = FALSE)
```
...
ggplot(data = pie_data, aes(x = "", y = value, fill=variable )) +
  geom_bar(stat = "identity", position = position_fill()) +
  scale_fill_manual(values = c( "#7868E6", "#B8B5FF"), labels=c("Population served", "Population not served")) +
